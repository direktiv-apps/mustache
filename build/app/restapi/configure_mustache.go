...
//go:generate swagger generate server --target ../../app --name Mustache --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/mustache/build/templates --principal interface{}

func configureFlags(api *operations.MustacheAPI) {
...
func configureAPI(api *operations.MustacheAPI) http.Handler {
